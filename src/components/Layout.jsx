...
const Layout = ({ children, title }) => {
  ...
  return (
    <div className="container-fluid d-flex justify-content-center align-items-start vh-100 pt-4">
      <div
        className="static-box-large p-4 rounded-4 shadow-lg d-flex flex-column"
        style={{
      ...
      >
        <div className="d-flex align-items-center justify-content-between mb-4 border-bottom border-secondary border-opacity-25 pb-3 flex-shrink-0">
          <div className="d-flex align-items-center">
            <div
              className="rounded-3 overflow-hidden d-flex align-items-center justify-content-center border border-secondary border-opacity-25"
              style={{
                width: "60px",
                height: "60px",
            ...
            <div className="ms-3">
              <h1
                className="text-white fw-bold mb-0 h3 text-uppercase tracking-wider"
              ...
              <div className="d-flex align-items-center">
                <span
                  className="text-warning fw-bold small text-uppercase me-2"
